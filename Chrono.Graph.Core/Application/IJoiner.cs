...
namespace Chrono.Graph.Core.Application
{
    public interface IJoiner
    {
        ...
        IJoiner Join<T, P>(Expression<Func<T, P>> operand, Action<IQueryClause> clause);
        IJoiner Join<T, P>(Expression<Func<T, P>> operand, Action<IJoiner> deepJoiner);
        IJoiner Join<T, P>(Expression<Func<T, P>> operand, Action<IQueryClause> clause, Action<IJoiner> deepJoiner);
        ...
        IJoiner JoinOptional<T, P>(Expression<Func<T, P>> operand, Action<IQueryClause> clause);
        IJoiner JoinOptional<T, P>(Expression<Func<T, P>> operand, Action<IJoiner> deepJoiner);
        IJoiner JoinOptional<T, P>(Expression<Func<T, P>> operand, Action<IQueryClause> clause, Action<IJoiner> deepJoiner);
    }
}
