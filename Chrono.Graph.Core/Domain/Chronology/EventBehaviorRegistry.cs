namespace Chrono.Graph.Core.Domain.Chronology
{
    public static class EventBehaviorRegistry<IO, T>
    {
        ...
        public static void Register(string key, Func<long, TimeController<IO, T>, IO, T, IO> func)
        {
            _map[key] = func;
        }

        public static Func<long, TimeController<IO, T>, IO, T, IO>? Resolve(string key)
        {
